...
<section class="bg-light-gray py-4 py-md-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto"> 
                <div class="card reclamaciones-card border-0 shadow-sm">
                    <div class="card-body p-3 p-md-5">
                        ...
                        <div class="text-center mb-4 mb-md-5 pb-3 pb-md-4 border-bottom">
                            <h1 class="title-reclamaciones text-uppercase mb-2 mb-md-3 fs-4 fs-md-2">Política de Privacidad</h1>
                            <p class="text-muted small mb-0">Última actualización: <strong>{{ date('d/m/Y') }}</strong></p>
                        </div>

                        <div class="text-start text-md-justify" style="color: #475569; line-height: 1.7; font-size: 0.95rem;">
                            ...
                            <h5 class="fw-bold mt-4 mt-md-5 mb-2 mb-md-3 fs-6 fs-md-5" style="color: #0f1d3a;">1. Información que es recogida</h5>
                            ...
                            <h5 class="fw-bold mt-4 mt-md-5 mb-2 mb-md-3 fs-6 fs-md-5" style="color: #0f1d3a;">2. Uso de la información recogida</h5>
                            <p>La información recopilada en nuestras plataformas se utiliza exclusivamente para los siguientes fines:</p>
                            <ul class="mb-4 ps-3 ps-md-4"> {{-- Ajuste de sangría en la lista --}}
                            ...
                            <h5 class="fw-bold mt-4 mt-md-5 mb-2 mb-md-3 fs-6 fs-md-5" style="color: #0f1d3a;">3. Banco de Datos y Seguridad</h5>
                            ...
                            <h5 class="fw-bold mt-4 mt-md-5 mb-2 mb-md-3 fs-6 fs-md-5" style="color: #0f1d3a;">4. Ejercicio de los Derechos ARCO</h5>
                            ...
                            <h5 class="fw-bold mt-4 mt-md-5 mb-2 mb-md-3 fs-6 fs-md-5" style="color: #0f1d3a;">5. Modificaciones</h5>
